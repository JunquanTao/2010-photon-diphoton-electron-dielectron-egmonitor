...
config.General.requestName = 'Run2010BPhoton_EGAnalyzer_Photon'
config.General.workArea = 'Run2010BPhoton_EGAnalyzer_Photon'
config.General.transferOutputs = True
config.General.transferLogs = False
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'PhotonElectronAnalyzer.py' 
config.JobType.outputFiles = ['PhotonElectron_Test.root']
config.Data.inputDataset = '/Photon/Run2010B-Apr21ReReco-v1/AOD'
