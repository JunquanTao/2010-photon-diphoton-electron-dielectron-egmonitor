...
void hggPaperStyle()
{
  ...
  hggStyle->SetPadTopMargin(0.02);//0.02);
  ...
  //hggStyle->SetTitleYOffset(1.25); // => 1.15 if exponents
  ...
  //hggStyle->SetLegendFillColor(0);
  //hggStyle->SetLegendFont(42);

  hggStyle->SetFillColor(0);
  // Nothing for now
  hggStyle->SetTextFont(42);
  hggStyle->SetTextSize(0.05);
  hggStyle->cd();
}
