...
Both examples exercises running locally on Run2010B photon data in the AOD format, http://opendata.cern.ch/record/12.

The codes were used for quick check on the plots of photon/diphoton/electron/dielectron  objects
